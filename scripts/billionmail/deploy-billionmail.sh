...
SafePath=${BILLIONMAIL_SAFEPATH:-billion}

# Hostname Configuration
BILLIONMAIL_HOSTNAME=${BILLIONMAIL_HOSTNAME:-${MAIL_DOMAIN:-localhost}}

# Database Configuration
DBNAME=${BILLIONMAIL_DB_NAME:-billionmail}
DBUSER=${BILLIONMAIL_DB_USER:-billionmail}
DBPASS=${BILLIONMAIL_DB_PASSWORD:-billionmail_db_2024}

# Redis Configuration
REDISPASS=${BILLIONMAIL_REDIS_PASSWORD:-}

# Mail Ports
SMTP_PORT=${BILLIONMAIL_SMTP_PORT:-25}
SMTPS_PORT=${BILLIONMAIL_SMTPS_PORT:-465}
SUBMISSION_PORT=${BILLIONMAIL_SUBMISSION_PORT:-587}
IMAP_PORT=${BILLIONMAIL_IMAP_PORT:-143}
IMAPS_PORT=${BILLIONMAIL_IMAPS_PORT:-993}
POP_PORT=${BILLIONMAIL_POP_PORT:-110}
POPS_PORT=${BILLIONMAIL_POPS_PORT:-995}
REDIS_PORT=127.0.0.1:${BILLIONMAIL_REDIS_PORT:-26379}
SQL_PORT=127.0.0.1:${BILLIONMAIL_SQL_PORT:-25432}

# Management Ports
HTTP_PORT=${BILLIONMAIL_HTTP_PORT:-${BILLIONMAIL_PORT:-8080}}
HTTPS_PORT=${BILLIONMAIL_HTTPS_PORT:-8443}

# Timezone
TZ=${BILLIONMAIL_TZ:-Asia/Shanghai}

# Network Configuration
IPV4_NETWORK=${BILLIONMAIL_IPV4_NETWORK:-172.66.1}

# Security Configuration
FAIL2BAN_INIT=${BILLIONMAIL_FAIL2BAN_INIT:-y}
IP_WHITELIST_ENABLE=${BILLIONMAIL_IP_WHITELIST_ENABLE:-false}
EOF

...
echo -e "   ${CYAN}邮件营销:${NC} http://localhost:8080/billion (BillionMail管理)"
echo -e "   ${CYAN}WebMail:${NC} http://localhost:8080/roundcube (邮件收发)"
echo -e "   ${CYAN}搜索管理:${NC} ${SEARCH_URL} (MeiliSearch管理)"
echo -e "   ${CYAN}API接口:${NC} ${BACKEND_API_URL} (后端API)"

...
"[project]/src/lib/billionmail.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
 ...
 */ // 从环境变量获取API URL
__turbopack_context__.s({
    "BILLIONMAIL_ENDPOINTS": ()=>BILLIONMAIL_ENDPOINTS,
    "checkBillionMailHealth": ()=>checkBillionMailHealth,
    "generateVerificationCode": ()=>generateVerificationCode,
    "getSubscriberStatus": ()=>getSubscriberStatus,
    "sendLoginVerificationCode": ()=>sendLoginVerificationCode,
...
async function sendLoginVerificationCode(email, userName) {
    // 生成6位数字验证码
    const verificationCode = Math.floor(100000 + Math.random() * 900000).toString();
    try {
        const response = await fetch(`${BILLIONMAIL_API_URL}/emails/send`, {
...
async function checkBillionMailHealth() {
    try {
...
"[project]/src/lib/hooks/useEmailSubscription.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$billionmail$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/billionmail.ts [app-ssr] (ecmascript)");
;
;
function useEmailSubscription() {
    ...
    const [error, setError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    // 重置错误状态
    const resetError = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(()=>{
        setError(null);
    }, []);
    // 邮件订阅
    const subscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (data)=>{
        setIsLoading(true);
        resetError();
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$billionmail$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["subscribeEmail"])(data);
            if (result.success) {
                return {
                    success: true,
    ...
    // 取消订阅
    const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (email)=>{
        setIsLoading(true);
        resetError();
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$billionmail$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["unsubscribeEmail"])(email);
            if (result.success) {
                return {
                    success: true,
                    message: result.message
    ...
    // 检查订阅状态
    const checkSubscriptionStatus = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (email)=>{
        setIsLoading(true);
        resetError();
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$billionmail$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getSubscriberStatus"])(email);
            if (result.success) {
                return {
                    success: true,
                    data: result.data,
    ...
    // 发送注册验证码
    const sendVerification = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (email, userName)=>{
        setIsLoading(true);
        resetError();
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$billionmail$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["sendVerificationCode"])(email, userName);
            if (result.success) {
                return {
                    success: true,
    ...
    // 发送登录验证码
    const sendLoginVerification = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (email, userName)=>{
        setIsLoading(true);
        resetError();
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$billionmail$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["sendLoginVerificationCode"])(email, userName);
            if (result.success) {
                return {
                    success: true,
                    verificationCode: result.verificationCode,
    ...
    // 发送欢迎邮件
    const sendWelcome = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (email, userName)=>{
        setIsLoading(true);
        resetError();
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$billionmail$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["sendWelcomeEmail"])(email, userName);
            if (result.success) {
                return {
                    success: true,
                    message: result.message
    ...
    // 验证邮箱格式
    const validateEmailFormat = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((email)=>{
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$billionmail$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["validateEmail"])(email);
    }, []);
    // 验证验证码格式
    const validateCodeFormat = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((code)=>{
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$billionmail$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["validateVerificationCode"])(code);
    }, []);
    return {
        // 状态
        isLoading,
...
"[project]/src/lib/verificationManager.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
class VerificationManager {
    STORAGE_KEY = 'verification_codes';
   ...
   */ async sendRegistrationCode(email, userName) {
        try {
            // 使用BillionMail发送验证码
            const { sendVerificationCode } = await __turbopack_context__.r("[project]/src/lib/billionmail.ts [app-ssr] (ecmascript, async loader)")(__turbopack_context__.i);
            ...
            if (result.success) {
                ...
                return {
                    ...
                    code: ("TURBOPACK compile-time truthy", 1) ? code : "TURBOPACK unreachable"
                };
            } else {
                return {
                    success: false,
   ...
   */ async sendLoginCode(email, userName) {
        try {
            ...
            const { sendLoginVerificationCode } = await __turbopack_context__.r("[project]/src/lib/billionmail.ts [app-ssr] (ecmascript, async loader)")(__turbopack_context__.i);
    ...
    /**
   * 验证验证码
   */ verifyCode(email, inputCode, type) {
        this.cleanupExpiredCodes();
        const codes = this.getStoredCodes();
        // 查找对应的验证码
        const codeIndex = codes.findIndex((c)=>c.email === email && c.type === type);
        if (codeIndex === -1) {
            return {
                success: false,
...
//# sourceMappingURL=src_lib_b3cee0df._.js.map
...
function useEmailSubscription() {
    ...
    const subscribe = async (email)=>{
        ...
        try {
            // 调用Strapi邮件订阅API
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$strapi$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["strapiApi"].post('/api/email-subscriptions', {
                data: {
...
//# sourceMappingURL=src_lib_fd4a2f2c._.js.map
    ...
    subgraph "🚀 一键部署架构 (bootstrap.sh)"
        ...
        subgraph "🚀 第2步: 启动阶段 (scripts.sh deploy start)"
            subgraph "🎯 统一部署服务群 (docker-compose.unified.yml)"
                ...
                D[Strapi 5.22.0 后端<br/>:1337]
                A[Next.js 15.4.2 前端<br/>:80]
...
#### 🎨 **前端技术栈**
- **Next.js 15.4.2** - React全栈框架，支持SSR/SSG，App Router架构
- **React 19.1.0** - 最新React版本，支持并发渲染和新特性
...
#### ⚙️ **后端技术栈**
- **Strapi 5.22.0** - 现代化无头CMS，完整TypeScript支持
- **PostgreSQL 17** - 企业级关系型数据库，ACID事务保证
...
# 📧 邮件服务 (集成到Strapi)
./scripts.sh email check        # 检查邮件系统状态
./scripts.sh email admin        # 打开邮件管理界面 (Strapi Admin)
```
...
**🚀 智能统一架构核心理念:**
- 📧 **邮件系统集成** - 深度集成到Strapi，统一管理界面
- 🎯 **核心服务统一** - 简化开发部署，配置管理集中
- 🔧 **智能决策** - 自动选择最优部署策略
- 🛡️ **数据一致性** - 统一数据模型，确保业务连贯性
